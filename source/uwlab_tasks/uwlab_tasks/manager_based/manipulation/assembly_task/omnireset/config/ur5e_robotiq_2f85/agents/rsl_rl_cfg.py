...
from uwlab_rl.rsl_rl import (  # noqa: F401
    BehaviorCloningCfg,
    ...
    algorithm = RslRlFancyPpoAlgorithmCfg(
        ...
        offline_algorithm_cfg=OffPolicyAlgorithmCfg(
            behavior_cloning_cfg=BehaviorCloningCfg(
                ...
                experts_observation_group_cfg="uwlab_tasks.manager_based.manipulation.assembly_task.omnireset.config.ur5e_robotiq_2f85.rl_state_cfg:ObservationsCfg.PolicyCfg",
