...
@configclass
class TrainRGBEventCfg(BaseRGBEventCfg):
...
class RGBCommandsCfg:
    ...
    task_command = task_mdp.TaskCommandCfg(
        ...
        success_orientation_threshold=float('inf'),  # only check for position since policy can't tell orientation of symmetric objects from rgb
    )
