...
from . import events as task_mdp_events
from .events import MultiResetManager, sample_from_nested_dict
    ...
    *,
    ...
    for variant_idx, v in enumerate(variants):
        ...
        if len(variant_env_ids) == 0:
            continue
        task_mdp_events.randomize_operational_space_controller_gains(
            env,
            variant_env_ids,
