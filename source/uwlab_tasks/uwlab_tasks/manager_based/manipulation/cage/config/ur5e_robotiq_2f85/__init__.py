...
gym.register(
    id="Cage-Ur5eRobotiq2f85-RelCartesianOSC-State-EvalCfgV0-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Cage-Ur5eRobotiq2f85-RelCartesianOSC-State-EvalCfgV1-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Cage-Ur5eRobotiq2f85-RelCartesianOSC-State-EvalCfgV2-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Cage-Ur5eRobotiq2f85-RelCartesianOSC-State-EvalCfgV3-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
# =============================================================================
# CAGE Adversary Environments
# =============================================================================

gym.register(
    id="Cage-Ur5eRobotiq2f85-Adversary-RelCartesianOSC-State-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Cage-Ur5eRobotiq2f85-Adversary-RelCartesianOSC-State-Recurrent-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rl_state_cfg:Ur5eRobotiq2f85AdversaryTrainCfg",
...
gym.register(
    id="Cage-Ur5eRobotiq2f85-Adversary-RelCartesianOSC-State-FullRecurrent-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rl_state_cfg:Ur5eRobotiq2f85AdversaryTrainCfg",
