...
@configclass
class Ur5eRobotiq2f85RelCartesianOSCEvalObjectRestingEEGraspedCfg(Ur5eRobotiq2f85RlStateCfg):
    """Eval: ObjectRestingEEGrasped resets."""
    ...
    def __post_init__(self):
        super().__post_init__()
        self.events.reset_from_reset_states.params["reset_types"] = ["ObjectRestingEEGrasped"]


@configclass
class Ur5eRobotiq2f85RelCartesianOSCEvalObjectAnywhereEEGraspedCfg(Ur5eRobotiq2f85RlStateCfg):
    """Eval: ObjectAnywhereEEGrasped resets."""
    ...
    def __post_init__(self):
        super().__post_init__()
        self.events.reset_from_reset_states.params["reset_types"] = ["ObjectAnywhereEEGrasped"]


@configclass
class Ur5eRobotiq2f85RelCartesianOSCEvalObjectPartiallyAssembledEEGraspedCfg(Ur5eRobotiq2f85RlStateCfg):
    """Eval: ObjectPartiallyAssembledEEGrasped resets."""
    ...
    def __post_init__(self):
        super().__post_init__()
        self.events.reset_from_reset_states.params["reset_types"] = ["ObjectPartiallyAssembledEEGrasped"]
